...
public class UIFunctions:IUF
{
    ...
    public void ObjMoveTo(GameObject obj, Vector2 pos, float speed)
    {
        ...
        {
            obj.transform.position += toVec3(Direction2((Vector2)obj.GetComponent<RectTransform>().position, pos) * speed * Time.unscaledDeltaTime);
        }
    }
    ...
    {
        Rect rect = new Rect(obj.transform.position.x+(0.5f- obj.GetComponent<RectTransform>().pivot.x)* obj.GetComponent<RectTransform>().rect.width * obj.GetComponent<RectTransform>().lossyScale.x,
          obj.transform.position.y + (0.5f - obj.GetComponent<RectTransform>().pivot.y) * obj.GetComponent<RectTransform>().rect.height * obj.GetComponent<RectTransform>().lossyScale.y, 
          obj.GetComponent<RectTransform>().rect.width* obj.GetComponent<RectTransform>().lossyScale.x,
          obj.GetComponent<RectTransform>().rect.height * obj.GetComponent<RectTransform>().lossyScale.y);
        return rect;
    }
    ...
    {
        Sprite image = obj.GetComponent<Image>().sprite;
